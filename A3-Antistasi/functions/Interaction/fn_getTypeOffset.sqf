...
switch (true) do {
    case ((_object isKindOf "CAManBase") && hasAce && _isObject): { _object selectionPosition "spine3" }; //upper torso
    case ((_object isKindOf "LandVehicle") && hasAce && _isObject): { _object selectionPosition "commander_turret"}; //ace being stupid, actions dosnt show otherwise (dont know why, out of reach?)
