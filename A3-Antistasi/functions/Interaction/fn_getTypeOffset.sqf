...
switch (true) do {
    case ((_type isKindOf "CAManBase") && _isObject): { _object selectionPosition "spine2" }; //upper torso
    case ((_type isKindOf "StaticWeapon") && _isObject): { _object selectionPosition "otocvez"};
    case (_type isKindOf "Tank"): { [0,0,-0.7] };
    case (_type isKindOf "Car"): { [0,0,-0.5] };
