...
_militaryLoadoutData set ["vests", ["V_LIB_DAK_VestSTG","V_LIB_DAK_VestMP40","V_LIB_DAK_VestMG","V_LIB_DAK_VestKar98","V_LIB_DAK_VestG43"]];
...
_militiaLoadoutData set ["helmets", ["H_LIB_DAK_Helmet","H_LIB_DAK_PithHelmet"]];
...
_crewLoadoutData set ["uniforms", ["U_LIB_DAK_Spg_crew_private","U_LIB_DAK_Spg_crew_leutnant","U_LIB_DAK_Spg_crew_unterofficer"]];
_crewLoadoutData set ["vests", ["V_LIB_GER_TankPrivateBelt"]];
_crewLoadoutData set ["helmets", ["H_LIB_DAK_Cap"]];
